...
MUTATIONS = [
    ...
    ("acceptance ref pinned in code", "research/fwd_protocol.py",
     "    pushed = committed_registrations(ref=ACCEPTANCE_REF)",
     '    pushed = committed_registrations(ref=registration.get("acceptance_ref") or ACCEPTANCE_REF)',
     "tests/test_fwd_protocol.py::test_the_acceptance_ref_is_pinned_in_code_never_read_from_the_local_file"),
    ("commit delay checked against git", "research/fwd_protocol.py",
     "    commit_time = committed[line].astimezone(timezone.utc)",
     '    commit_time = (_utc(registration["accepted_commit_time_utc"]) if registration.get("accepted_commit_time_utc")\n                   else committed[line].astimezone(timezone.utc))',
     "tests/test_fwd_protocol.py::test_the_commit_delay_is_always_checked_against_git_never_a_stored_time"),
    ("kill switch re-reads positions after the view", "risk/kill_switch.py",
     "        positions = self._account_positions()\n        position_ids", "        position_ids",
     "tests/test_kill_switch_drill.py::test_kill_switch_classifies_a_position_that_opened_while_it_waited_for_the_view"),
    ("kill switch: unknown own clientId = unusable view", "risk/kill_switch.py",
     "        if own_client is None:\n            # Without", "        if False:\n            # Without",
     "tests/test_kill_switch_drill.py::test_kill_switch_without_its_own_client_id_treats_the_view_as_unusable"),
