...
READ_ONLY_RUNNERS = [
    ...
    "run_confluence_gen4.py", "run_confluence_lab.py", "run_event_families.py", "run_experiments.py", "run_fetch_journal_bars.py", "run_growth_projection.py",
    "run_import_context_promotions.py", "run_monthly_target_suite.py", "run_null_benchmark.py", "run_pipeline_backtest.py",
    "run_research.py", "run_reset_drawdown_lock.py", "run_score_shadow.py", "run_shadow_only.py", "run_shadow_report.py", "run_paper_preflight.py", "run_reset_execution_lock.py", "run_strategy_suite.py", "run_universe_probe.py", "run_validation_suite.py",
]
