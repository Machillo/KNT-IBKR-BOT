...
READ_ONLY_RUNNERS = [
    ...
    "run_research.py", "run_reset_drawdown_lock.py", "run_score_shadow.py", "run_shadow_only.py", "run_shadow_report.py", "run_strategy_suite.py", "run_universe_probe.py", "run_validation_suite.py",
]
