...
MUTATIONS = [
    ...
    ("kill switch: keep protection of manual positions", "risk/kill_switch.py",
     "            if con_id(trade) and con_id(trade) in manual_con_ids:", "            if False:",
    ...
    ("candidate error share gate", "research/shadow_quality.py",
     'severity = "BLOCKING" if share > MAX_CANDIDATE_ERROR_SHARE else "WARNING"', 'severity = "WARNING"',
     "tests/test_shadow_quality.py::test_a_cycle_with_many_failed_candidates_is_blocking"),
